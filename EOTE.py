...
def generate_email():
    ...
    leaver_last_day = leaver_last_day_entry.get()
...
def clear_fields():
    ...
    leaver_last_day_entry.delete(0, tk.END)
    email_text.delete(1.0, tk.END)
...
leaver_last_day_entry = tk.Entry(root, width=40)
leaver_last_day_entry.grid(row=2, column=1, padx=10, pady=5)

email_text = tk.Text(root, width=60, height=15, wrap=tk.WORD)
email_text.grid(row=3, column=0, columnspan=2, padx=10, pady=10)
